...
public class MemberRankingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rankingsList.add(new RankingsModel(R.drawable.face1, "Sawano", "10", "653"));
    ...
    private void initToolBar() {
        ...
        if (getSupportActionBar() != null) getSupportActionBar().setTitle("Member Ranks");
